...
package org.szeliga.taskerwidget_plugin.bundle;
...
import org.szeliga.taskerwidget_plugin.Constants;
import org.szeliga.taskerwidget_plugin.vendor.TaskerPlugin;
...
public final class PluginBundleManager
{
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_MESSAGE = "org.szeliga.taskerwidget_plugin.STRING_MESSAGE"; //$NON-NLS-1$
    public static final String BUNDLE_EXTRA_STRING_ARAAY = "org.szeliga.taskerwidget_plugin.STRING_ARRAY"; //$NON-NLS-1$
     ...
     */
    public static final String BUNDLE_EXTRA_INT_VERSION_CODE = "org.szeliga.taskerwidget_plugin.VERSION_CODE"; //$NON-NLS-1$
    ...
    public static boolean isBundleValid(final Bundle bundle)
    {
        ...
        if (!bundle.containsKey(BUNDLE_EXTRA_STRING_MESSAGE))
        {
            if (Constants.IS_LOGGABLE)
            {
                Log.e(Constants.LOG_TAG,
                      String.format("[TASKERWIDGET] bundle must contain extra %s", BUNDLE_EXTRA_STRING_MESSAGE)); //$NON-NLS-1$
            }
            //return false;
        }
        if (!bundle.containsKey(BUNDLE_EXTRA_INT_VERSION_CODE))
        {
            ...
            {
                Log.e(Constants.LOG_TAG,
                      String.format("[TASKERWIDGET] bundle must contain extra %s", BUNDLE_EXTRA_INT_VERSION_CODE)); //$NON-NLS-1$
            }
            //return false;
        }
        ...
        if (size != bundle.keySet().size())
        {
            if (Constants.IS_LOGGABLE)
            {
                Log.e(Constants.LOG_TAG,
                      String.format("[TASKERWIDGET] bundle must contain " + size + " keys, but currently contains %d keys: %s", bundle.keySet().size(), bundle.keySet())); //$NON-NLS-1$
            }
            return false;
        }
        ...
        if (TextUtils.isEmpty(bundle.getString(BUNDLE_EXTRA_STRING_MESSAGE)))
        {
            ...
            {
                Log.e(Constants.LOG_TAG,
                      String.format("[TASKERWIDGET] bundle extra %s appears to be null or empty.  It must be a non-empty string", BUNDLE_EXTRA_STRING_MESSAGE)); //$NON-NLS-1$
            }
            return false;
        }
        ...
        if (bundle.getInt(BUNDLE_EXTRA_INT_VERSION_CODE, 0) != bundle.getInt(BUNDLE_EXTRA_INT_VERSION_CODE, 1))
        {
            ...
            {
                Log.e(Constants.LOG_TAG,
                      String.format("[TASKERWIDGET] bundle extra %s appears to be the wrong type.  It must be an int", BUNDLE_EXTRA_INT_VERSION_CODE)); //$NON-NLS-1$
            }
