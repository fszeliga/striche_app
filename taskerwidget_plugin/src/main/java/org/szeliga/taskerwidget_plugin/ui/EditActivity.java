...
package org.szeliga.taskerwidget_plugin.ui;
...
import org.szeliga.android.taskerwidget.plugin.R;
import org.szeliga.taskerwidget_plugin.bundle.BundleScrubber;
import org.szeliga.taskerwidget_plugin.bundle.PluginBundleManager;
    ...
    public void finish()
    {
        if (!isCanceled())
        {
            ...
            if (message.length() > 0)
            {
                ...
                /*
                 * The blurb is concise status text to be displayed in the host's UI (in tasker under configuration)
                 */
                ...
                //    TaskerPlugin.Setting.setVariableReplaceKeys( resultBundle, new String [] { PluginBundleManager.BUNDLE_EXTRA_STRING_MESSAGE, "%pcolour" } );
            }
        }
